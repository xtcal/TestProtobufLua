...
public static class CustomSettings {
	...
	public static BindType[] customTypeList = {
		...
		_GT (typeof (DG.Tweening.Core.Surrogates.ColorWrapper)),
		_GT (typeof (Component)).AddExtendType (typeof (DG.Tweening.ShortcutExtensions)),
		_GT (typeof (Transform)).AddExtendType (typeof (DG.Tweening.ShortcutExtensions)).AddExtendType (typeof (MethodExtension)),
