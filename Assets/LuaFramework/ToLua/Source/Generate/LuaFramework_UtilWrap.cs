...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SHA1file", SHA1file);
	...
	static int SHA1file(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes<byte[]>(L, 1))
			{
				...
				string o = LuaFramework.Util.SHA1file(arg0);
				LuaDLL.lua_pushstring(L, o);
				return 1;
			}
			...
			else if (count == 2)
			{
				...
				string o = LuaFramework.Util.SHA1file(arg0, ref arg1);
				LuaDLL.lua_pushstring(L, o);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.Util.SHA1file");
			}
		}
		catch (Exception e)
		{
